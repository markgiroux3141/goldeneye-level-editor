/* @ts-self-types="./cave_wasm.d.ts" */

export class CaveWorld {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        CaveWorldFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_caveworld_free(ptr, 0);
    }
    /**
     ...
     * @returns {boolean}
     */
    apply_brush(mode, cx, cy, cz, radius, strength, dt) {
        const ret = wasm.caveworld_apply_brush(this.__wbg_ptr, mode, cx, cy, cz, radius, strength, dt);
        return ret !== 0;
    }
    /**
     ...
     */
    flush_dirty() {
        const ret = wasm.caveworld_flush_dirty(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} cx
     ...
     * @param {number} freq
     */
    init_hollow_cavity(cx, cy, cz, radius, amp, freq) {
        wasm.caveworld_init_hollow_cavity(this.__wbg_ptr, cx, cy, cz, radius, amp, freq);
    }
    /**
     ...
     */
    mesh_chunk(cx, cy, cz) {
        const ret = wasm.caveworld_mesh_chunk(this.__wbg_ptr, cx, cy, cz);
        return ret === 0 ? undefined : MeshHandle.__wrap(ret);
    }
    /**
     * @param {number} voxel_size
     * @param {number} default_density
     */
    constructor(voxel_size, default_density) {
        const ret = wasm.caveworld_new(voxel_size, default_density);
        this.__wbg_ptr = ret >>> 0;
        CaveWorldFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    set_boundary_clip(aabbs) {
        const ptr0 = passArrayF32ToWasm0(aabbs, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.caveworld_set_boundary_clip(this.__wbg_ptr, ptr0, len0);
    }
}
if (Symbol.dispose) CaveWorld.prototype[Symbol.dispose] = CaveWorld.prototype.free;
...
export class MeshHandle {
     ...
     */
    uvs() {
        const ret = wasm.meshhandle_uvs(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {number}
     */
    vert_count() {
        const ret = wasm.meshhandle_vert_count(this.__wbg_ptr);
        return ret >>> 0;
    }
}
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_with_length_4a23e9076388f28c: function(arg0) {
    ...
    return {
        __proto__: null,
        "./cave_wasm_bg.js": import0,
    };
}

const CaveWorldFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_caveworld_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('cave_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
